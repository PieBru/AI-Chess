...
| Interface language (EN/IT) | FR-9.13 | 🌐 selector on the setup page, persisted, app-wide; Tier B (chrome + narration + status + reasons; tooltips/toasts/result-prose stay EN) |
